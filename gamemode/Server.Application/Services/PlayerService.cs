...
namespace Server.Application.Services
{
    public class PlayerService
    {
        ...
        internal void SetPlayerHealth(GFPlayer admin, GFPlayer targetPlayer, int value)
        {
        ...
        internal void SetPlayerArmour(GFPlayer admin, GFPlayer targetPlayer, int value)
        {
        ...
        internal void SetPlayerPos(GFPlayer targetPlayer, Vector3 position)
        {
            this.playerActions.SetPlayerPos(targetPlayer, position);
        }

        internal void SetPlayerSelectedHouse(GFPlayer admin, GFPlayer targetPlayer, int houseId)
        {
        ...
        internal void SpawnPlayer(GFPlayer player)
        {
